    ...
    RageUIJob.Visible(MenuBoss, not RageUIJob.Visible(MenuBoss))
            ...
            RageUIJob.IsVisible(MenuGestEmployeJobs, true, true, true, function()
                ...
                if #JobsEmployeList == 0 then
                    RageUIJob.Separator("")
                    RageUIJob.Separator("~r~Aucun Employé")
                    RageUIJob.Separator("")
                end

                for k,v in pairs(JobsEmployeList) do
                    RageUIJob.ButtonWithStyle(v.Name, false, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            Ply = v
                        end
            ...
            RageUIJob.IsVisible(MenuGestEmployeJobs2, true, true, true, function()
                ...
                RageUIJob.ButtonWithStyle("Virer ~b~"..Ply.Name,nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                ...
                RageUIJob.ButtonWithStyle("Promouvoir ~b~"..Ply.Name,nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                ...
                RageUIJob.ButtonWithStyle("Destituer ~b~"..Ply.Name,nil, {RightLabel = "~b~→"}, true, function(Hovered, Active, Selected)
                    if Selected then
