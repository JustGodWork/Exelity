...
Config["ServerName"] = "Exelity"; -- Server name
Config["ServerColor"] = "purple"; -- red, green, blue, yellow, purple, pink, orange, grey, black, white
Config["ServerImage"] = "https://i.imgur.com/WCoAySU.png"; -- red, green, blue, yellow, purple, pink, orange, grey, black, white
...
Config["AdvancedNotification"]["Custom"] = function(sender, subject, message, textureDict, iconType, flash, saveToBrief, hudColorIndex) -- Custom notification function
    TriggerEvent("bulletin:sendAdvanced", message, sender, subject, nil, nil, "bottomleft", true, nil, "message");
end
