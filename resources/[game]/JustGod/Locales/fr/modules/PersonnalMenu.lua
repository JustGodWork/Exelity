--[[
----
----Created Date: 6:17 Thursday December 22nd 2022
----Author: JustGod
----Made with ❤
----
----File: [PersonnalMenu]
...
Shared.Lang:Insert("fr", {
    ...
    ["personnal_menu_vehicle_extra_no_extra"] = "~r~Aucun extra disponible.",
    ["personnal_menu_vehicle_engine_on"] = "~g~Moteur en fonctionnement",
    ["personnal_menu_vehicle_engine_off"] = "~r~Moteur éteint",
    ["personnal_menu_vehicle_doors_button_label"] = "Gestion des portes:",
    ["personnal_menu_vehicle_engine_button_label"] = "Status:",
    ["personnal_menu_vehicle_not_in_vehicle"] = "~r~Vous n'êtes pas dans un véhicule.",
