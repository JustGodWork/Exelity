...
function _Client.open:glassesMenu()
    ...
    while glassesMenu do
        ...
        RageUIClothes.IsVisible(glassesMenu, function()
            ...
            RageUIClothes.Line()
            RageUIClothes.List('Lunette 1', Lunette1, filter.accessories.Lunette1, desc, {}, true, { onActive = function() Uclothes:OnRenderCam() end, onListChange = function(Index, Item) filter.accessories.Lunette1 = Index filter.accessories.Lunette2 = 1 TriggerEvent('skinchanger:change', 'glasses_1', filter.accessories.Lunette1 - 1) end, onSelected = function() local result = Uclothes:input('Indiquez le numéro que vous souhaitez sélectionner :') if result ~= "" and tonumber(result) ~= nil then filter.accessories.Lunette1 = result TriggerEvent('skinchanger:change', 'glasses_1', filter.accessories.Lunette1 - 1) else ESX.ShowNotification('~r~Il semblerait que vous n\'avez entré aucune valeur. Assurez vous qu\'il s\'agisse bel et bien d\'un chiffre/nombre.') end end})
            RageUIClothes.List('Lunette 2', Lunette2, filter.accessories.Lunette2, desc, {}, true, { onActive = function() Uclothes:OnRenderCam() end, onListChange = function(Index, Item) filter.accessories.Lunette2 = Index TriggerEvent('skinchanger:change', 'glasses_2', filter.accessories.Lunette2 - 1) end, onSelected = function() local result = Uclothes:input('Indiquez le numéro que vous souhaitez sélectionner :') if result ~= "" and tonumber(result) ~= nil then filter.accessories.Lunette2 = result TriggerEvent('skinchanger:change', 'glasses_2', filter.accessories.Lunette2 - 1) else ESX.ShowNotification('~r~Il semblerait que vous n\'avez entré aucune valeur. Assurez vous qu\'il s\'agisse bel et bien d\'un chiffre/nombre.') end end})
