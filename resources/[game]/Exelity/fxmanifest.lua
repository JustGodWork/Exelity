...
client_scripts {
	...
	'gameManager/modules/client/door/*.lua',
	'gameManager/modules/client/meteo/*.lua',
	'gameManager/modules/client/moneywash/*.lua',
	...
	'gameManager/modules/client/radar/*.lua',
	...
	'gameManager/Bjobs/client/taxi/**',
	'gameManager/Bjobs/client/unicorn/*.lua',
	'gameManager/Bjobs/client/bahamas/*.lua',
	'gameManager/Bjobs/client/burgershot/**',
	'gameManager/Bjobs/client/avocat/**',
	---------------------
	------ ASSETS -------
	---------------------
	'property/client/*.lua',
...
server_scripts {
	...
	'gameManager/modules/server/radar/*.lua',
	'gameManager/modules/server/xp/*.lua',
	'gameManager/modules/server/door/*.lua',
	...
	'gameManager/modules/server/moneywash/*.lua',
	...
	------ JOBS -------
	-------------------
	'gameManager/Bjobs/server/taxi/**',
	'gameManager/Bjobs/server/unicorn/*.lua',
	'gameManager/Bjobs/server/bahamas/*.lua',
	'gameManager/Bjobs/server/burgershot/**',
	'gameManager/Bjobs/server/avocat/**',
	-----------------------
	------- InitESX -------
	-----------------------
