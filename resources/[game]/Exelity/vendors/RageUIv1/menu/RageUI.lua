        ...
        if Enabled == true then
            ...
            if RageUIv1.CurrentMenu ~= nil then
                if RageUIv1.CurrentMenu() then
                    ...
                    --if (RageUIv1.CurrentMenu.WidthOffset == 100) then
                        if Glare then
							...
							---@type number
							local GlareX = RageUIv1.CurrentMenu.X / 1920 + (RageUIv1.CurrentMenu.SafeZoneSize.X / (64.399 - (RageUIv1.CurrentMenu.WidthOffset * 0.065731)))
                            ---@type number
                            local GlareY = RageUIv1.CurrentMenu.Y / 1080 + RageUIv1.CurrentMenu.SafeZoneSize.Y / 33.195020746888
