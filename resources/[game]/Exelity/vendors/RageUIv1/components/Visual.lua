...
function RageUIv1.staffModeDesc(title, color, components)
    if not IsPedInAnyVehicle(PlayerPedId(), false) then
        RageUIv1.drawTexts(baseX - 0.6500, baseY - (0.100) - 0.013, title, false, 0.50, { 130,0,184,  255 }, 4, 0)
        ...
        RageUIv1.drawTexts(baseX - 0.6500, baseY - 0.110, "", false, 0.7, { 130,0,184,  255 }, 4, 0)
    end
end