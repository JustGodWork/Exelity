	...
	if xPlayer.job.name == society.name then
		TriggerEvent(pSocietyCFG.AddonAccount, society.account, function(account)
			if amount > 0 and account.money >= amount then
				SendLogs("Entreprise", "Exelity | Entreprise", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de récupérer "..amount.."$ de l'entreprise **"..society.name.."**", "https://discord.com/api/webhooks/1046865316430499900/BPif4YglN47DvspGE_bgpvrWZP5WbO9EdEBvcu58pI6K1nmTPtFMPDCf2SQCPDN1Esbm")
...
AddEventHandler('pSociety:depositMoney', function(society, amount)
	...
	if xPlayer.job.name == society.name then
		if amount > 0 and xPlayer.getAccount('cash').money >= amount then
			TriggerEvent(pSocietyCFG.AddonAccount, society.account, function(account)
				SendLogs("Entreprise", "Exelity | Entreprise", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de déposer "..amount.."$ de l'entreprise **"..society.name.."**", "https://discord.com/api/webhooks/1046865316430499900/BPif4YglN47DvspGE_bgpvrWZP5WbO9EdEBvcu58pI6K1nmTPtFMPDCf2SQCPDN1Esbm")
