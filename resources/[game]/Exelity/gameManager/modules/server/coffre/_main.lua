...
function VehicleTrunk:logToDiscord(name,message,color)
    ...
    local DiscordWebHook = 'https://discord.com/api/webhooks/1015318411993165886/4XEQB9J0pb4iie6vC1XutosAJRuclFUSKUzbClS-1CypH2fAGr7hS6bKV46hQ8WEVuxY'
...
VehicleTrunk.Config = {
    maxWeight = {
        ...
        [GetHashKey("512tr")] = 50.0,
        [GetHashKey("765lt")] = 50.0,
        [GetHashKey("911venom")] = 200.0,
        [GetHashKey("hurlbp")] = 50.0,
        [GetHashKey("rmodatlantic")] = 50.0,
        [GetHashKey("rmodmartin")] = 50.0,
        [GetHashKey("rmodrs5")] = 100.0,
        [GetHashKey("rmodsupra")] = 75.0,
        [GetHashKey("rt70")] = 100.0,
        [GetHashKey("supersport")] = 50.0,
        [GetHashKey("trx")] = 200.0,
        [GetHashKey("wraith")] = 100.0,
        [GetHashKey("x6m")] = 150.0,
        [GetHashKey("19x7m")] = 150.0,
        [GetHashKey("21durangowb")] = 150.0,
        [GetHashKey("gxgallardo")] = 50.0,
        [GetHashKey("IKX3GP22")] = 50.0,
        [GetHashKey("m3vor")] = 80.0,
        [GetHashKey("rs3s20")] = 70.0,
        [GetHashKey("dv4r")] = 10.0,
