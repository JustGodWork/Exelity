...
local function StopDriveTest(success)
	if success then
		...
		ESX.ShowAdvancedNotification('Mme Pavoshko', '~r~Bravo', 'Vous avez reçu votre permis !', 'CHAR_MOLLY', 'CHAR_MOLLY')
		...
		ESX.ShowAdvancedNotification('Mme Pavoshko', '~r~Malheureusement', 'Vous avez raté le test !', 'CHAR_MOLLY', 'CHAR_MOLLY')			
		if DoesEntityExist(GetVehiclePedIsIn(PlayerPedId(), false)) then
			DeleteEntity(GetVehiclePedIsIn(PlayerPedId(), false))
			SetVehicleAsNoLongerNeeded(GetVehiclePedIsIn(PlayerPedId(), false))
		end
...
local CheckPoints = {

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Allons sur la route, tournez à droite, vitesse limitée à ~y~80km/h", 'CHAR_MOLLY', 'CHAR_MOLLY')
...

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Continuez tout droit", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 1
		end
	},

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Vous entrez sur l'autoroute, vitesse limitée à ~y~120km/h", 'CHAR_MOLLY', 'CHAR_MOLLY')
...

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Continuez sur l'autoroute", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 2
		end
	},

	{
        ...
        Action = function(playerPed, setCurrentZoneType)
            ESX.ShowAdvancedNotification('Mme Pavoshko', 'Tournez !', "Tournez à droite, n'oubliez pas vos clignotants", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 2
		end
	},

	{
		...
		Action = function(playerPed, setCurrentZoneType)
            ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien !', "Continuez sur cette voie", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 2
		end
	},

	{
		...
		Action = function(playerPed, setCurrentZoneType)
            ESX.ShowAdvancedNotification('Mme Pavoshko', 'Votre Attention', "Préparez vous à prendre la sortie à droite", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 2
		end
	},
...

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Prenez la prochaine sortie", 'CHAR_MOLLY', 'CHAR_MOLLY') --## 393.65, -111.565, 65.29
			TesOuFDPRendMonQuad = 2
		end
	},
 --
	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Prenez à droite, vitesse limité à ~y~80km/h", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 1
		end
	},
...

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Tourner à gauche", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 1
		end
	},
...

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Prenez la prochaine à droite", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 1
		end
	},

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Ralentissez.", 'CHAR_MOLLY', 'CHAR_MOLLY') -- ici
			TesOuFDPRendMonQuad = 1
		end
	},

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Tournez à gauche", 'CHAR_MOLLY', 'CHAR_MOLLY') -- ici
			TesOuFDPRendMonQuad = 1
		end
	},

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Tourner à droite", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 1
		end
	},
...

	{
		...
		Action = function(playerPed, setCurrentZoneType)
			ESX.ShowAdvancedNotification('Mme Pavoshko', 'Bien', "Dernière ligne droite !", 'CHAR_MOLLY', 'CHAR_MOLLY')
			TesOuFDPRendMonQuad = 1
		end
	},
		...
		if CurrentTest == 'drive' then
			...
			if IsPedInAnyVehicle(PlayerPedId(), false) then
				...
				if TesOuFDPRendMonQuad == 0 and GetSpeed >= speed_limit_residence then
					...
					if DriveErrors <= 5 then
						ESX.ShowAdvancedNotification('Mme Pavoshko', '~r~Vous avez fait une erreur', "Vous roulez trop vite, vitesse limite : " ..speed_limit_residence.. " km/h!\n~r~Nombre d'erreurs " ..DriveErrors.. "/5", 'CHAR_MOLLY', 'CHAR_MOLLY')
					end
					Wait(2000) -- evite bug
				end
				...
				if TesOuFDPRendMonQuad == 1 and GetSpeed >= speed_limit_ville then
					...
					IsAboveSpeedLimit = true
					if DriveErrors <= 5 then
						ESX.ShowAdvancedNotification('Mme Pavoshko', '~r~Vous avez fait une erreur', "Vous roulez trop vite, vitesse limite : " ..speed_limit_ville.. " km/h!\n~r~Nombre d'erreurs " ..DriveErrors.. "/5", 'CHAR_MOLLY', 'CHAR_MOLLY')
					end
					Wait(2000)
				end
				...
				if TesOuFDPRendMonQuad == 2 and GetSpeed >= speed_limit_otoroute then
					...
					IsAboveSpeedLimit = true
					if DriveErrors <= 5 then
						ESX.ShowAdvancedNotification('Mme Pavoshko', '~r~Vous avez fait une erreur', "Vous roulez trop vite, vitesse limite : " ..speed_limit_otoroute.. " km/h!\n~r~Nombre d'erreurs " ..DriveErrors.. "/5", 'CHAR_MOLLY', 'CHAR_MOLLY')
					end
					Wait(2000)
				end
				...
				if HasEntityCollidedWithAnything(vehicle) and DamageControl == 0 then
					DriveErrors       = DriveErrors + 1
					if DriveErrors <= 5 then
						ESX.ShowAdvancedNotification('Mme Pavoshko', '~r~Vous avez fait une erreur', "Votre vehicule s\'est pris des dégats\n~r~Nombre d'erreurs " ..DriveErrors.. "/5", 'CHAR_MOLLY', 'CHAR_MOLLY')
					end
					Wait(2000)
				end
...
local function StartDriveTest()
	...
	ESX.ShowAdvancedNotification('Mme Pavoshko', '~r~Me voila !', 'Tenez votre voiture, bonne route et bonne chance !', 'CHAR_MOLLY', 'CHAR_MOLLY')
...
permisencours = "bike"
	...
	pedssss = CreatePedInsideVehicle(veh, 5, 0x242C34A7, 0, true, false)
	SetEntityAsMissionEntity(pedssss, 0, 0)
	ESX.ShowAdvancedNotification('Mme Pavoshko', '~r~Me voila !', 'Tenez votre moto, bonne route et bonne chance !', 'CHAR_MOLLY', 'CHAR_MOLLY')
...
RMenuv1.Add('rz-permis', 'main', RageUIv1.CreateMenu("", "~p~Bienvenue à l\'auto-ecole"))
        ...
        Citizen.CreateThread(function()
			while AutoEcoleS.Menu do
				RageUIv1.IsVisible(RMenuv1:Get('rz-permis', 'main'), true, true, true, function()
					...
					RageUIv1.ButtonWithStyle("Passer le permis", "Passer le permis pour ~p~1200$.", { RightLabel = "1200$" }, true, function(_, _, Selected)
						if Selected then
							StartDriveTest()
