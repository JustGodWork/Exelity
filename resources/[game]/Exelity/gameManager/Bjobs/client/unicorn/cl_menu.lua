...
local initthrowingbillet = false
...
CoordsThrowing = {
    vector3(114.5773, -1290.264, 28.26094),
    vector3(115.0809, -1285.843, 28.26344),
    vector3(110.7191, -1283.909, 28.26094)
}
    ...
    Citizen.CreateThread(function()
        while initthrowingbillet do
            ...
            for k,v in pairs(CoordsThrowing) do
                ...
                DrawMarker(29, v, 0, 0, 0, 180.0,nil,nil, 0.3, 0.3, 0.3, 130, 0, 184, 255, false, true, nil, true)
...
AddEventHandler("Unicorn:StartStrip", function()
    ...
    TaskGoToCoordAnyMeans(npc, 112.2573, -1287.273, 28.45904, 265.902, 0, 0, 786603, 1.0)
    Wait(3000)
    ...
    netScene3 = CreateSynchronizedScene(112.2573, -1287.273, 28.45904, vec3(0.0, 0.0, 0.0), 2)
