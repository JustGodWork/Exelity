...
Citizen.CreateThread(function()
    x,y,z = -790.4129, -217.7974, 37.25198
                ...
                if v.category == theCategories then
                    RageUI.Button(v.name, nil , {RightLabel = "→"}, true, {
                        onSelected = function()
                            ...
                            SetEntityCoords(plyPed, -769.4286, -231.1507, 37.26457)
                            local vehicle = v.model
                            TriggerServerEvent('cardealer:changeBucket', "enter")
                            ESX.Game.SpawnLocalVehicle(vehicle, {x = -769.4286, y = -231.1507, z = 37.26457}, 203.99, function (vehicle)
