	...
	if type == 'item_standard' then
		...
		if playerItem.count >= count and count > 0 then
			TriggerEvent('esx_addoninventory:getInventory', 'property', xPlayerOwner.identifier, function(inventory)
				...
				SendLogs("Appartement", "Exelity | Property", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de déposer **"..count.."** item (**"..i.label.."**) dans son appartement", "https://discord.com/api/webhooks/1043362016972255232/9vCDlOck6x7Z0KKtEf9fDlo5R9bVT78ABg5enRGuUxGPKxdcwtaICgozTEXctSXAcWNo")
			end)
		else
	...
	elseif type == 'item_account' then
		...
		if xAccount.money >= count and count > 0 then
			TriggerEvent('esx_addonaccount:getAccount', 'property_' .. item, xPlayerOwner.identifier, function(account)
				...
				SendLogs("Appartement", "Exelity | Property", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de déposer **"..count.."$** (**"..item.."**) dans son appartement", "https://discord.com/api/webhooks/1043362016972255232/9vCDlOck6x7Z0KKtEf9fDlo5R9bVT78ABg5enRGuUxGPKxdcwtaICgozTEXctSXAcWNo")
			end)
		else
		...
		if xPlayer.hasWeapon(weaponName) then
			...
			if not isPermanent then
				TriggerEvent('esx_datastore:getDataStore', 'property', xPlayerOwner.identifier, function(store)
					...
					SendLogs("Appartement", "Exelity | Property", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de déposer une arme **"..weaponName.."** dans son appartement", "https://discord.com/api/webhooks/1043362016972255232/9vCDlOck6x7Z0KKtEf9fDlo5R9bVT78ABg5enRGuUxGPKxdcwtaICgozTEXctSXAcWNo")
				end)
			else
		...
		TriggerEvent('esx_addoninventory:getInventory', 'property', xPlayerOwner.identifier, function(inventory)
			...
			if inventoryItem.count >= count and count > 0 then
				if xPlayer.canCarryItem(item, count) then
					...
					SendLogs("Appartement", "Exelity | Property", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de prendre **"..count.."** item (**"..inventory.getItem(item).label.."**) dans son appartement", "https://discord.com/api/webhooks/1043362016972255232/9vCDlOck6x7Z0KKtEf9fDlo5R9bVT78ABg5enRGuUxGPKxdcwtaICgozTEXctSXAcWNo")
				else
	...
	elseif type == 'item_account' then
		TriggerEvent('esx_addonaccount:getAccount', 'property_' .. item, xPlayerOwner.identifier, function(account)
			if account.money >= count and count > 0 then
				...
				SendLogs("Appartement", "Exelity | Property", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de prendre **"..count.."$** (**"..item.."**) dans son appartement", "https://discord.com/api/webhooks/1043362016972255232/9vCDlOck6x7Z0KKtEf9fDlo5R9bVT78ABg5enRGuUxGPKxdcwtaICgozTEXctSXAcWNo")
			...
			if not xPlayer.hasWeapon(weaponName) then
				...
				for i = 1, #weapons, 1 do
					if weapons[i].name == weaponName and weapons[i].ammo == count then
						...
						SendLogs("Appartement", "Exelity | Property", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de prendre une arme **"..weaponName.."** dans son appartement", "https://discord.com/api/webhooks/1043362016972255232/9vCDlOck6x7Z0KKtEf9fDlo5R9bVT78ABg5enRGuUxGPKxdcwtaICgozTEXctSXAcWNo")
						break
					end
				end
			else
...
function logToDiscordApart(name,message,color)
    ...
    local DiscordWebHook = 'https://discord.com/api/webhooks/1043362016972255232/9vCDlOck6x7Z0KKtEf9fDlo5R9bVT78ABg5enRGuUxGPKxdcwtaICgozTEXctSXAcWNo'
