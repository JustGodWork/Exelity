...
Locales['fr'] = {
	...
	['press_to_rob'] = 'appuyer sur ~INPUT_CONTEXT~ pour braquer ~p~',
	['robbery_of'] = 'braquage de banque: ~r~',
	['seconds_remaining'] = ' secondes restantes',
	['robbery_cancelled_at'] = '~r~ Braquage annulé à: ~p~',
	['robbery_has_cancelled'] = '~r~ le braquage à été annulé: ~p~',
	['already_robbed'] = 'cette banque a déjà été braqué. Veuillez attendre: ',
	['seconds'] = 'secondes.',
	['rob_in_prog'] = '~r~ braquage en cours à: ~p~',
	...
	['robbery_complete_at'] = '~r~ Braquage terminé à: ~p~',
	...
	['rob_in_prog2'] = '~r~ Braquage en cours à: ~p~',
	...
	['min_two_police'] = 'Il doit y avoir au moins ~p~ ',
	...
	['act_imp_police'] = 'action ~r~impossible~s~, ~p~policiers~s~: ~p~%s~s~/~y~%s~s~ online',
	...
	['used_one_weed'] = 'Vous avez utilisé 1 Pochon de ~p~weed',
	...
	['used_one_opium'] = 'Vous avez utilisé 1 Pochon de ~p~opium',
	...
	['with'] = 'avec',
	-- Basic Needs
	['used_bread'] = 'Vous avez mangé un ~p~pain~s~',
	['used_water'] = 'Vous avez bu une bouteille ~p~eau~s~',
	['used_vine'] = 'Vous avez bu une bouteille de ~p~vin~s~',
	['used_mojito'] = 'Vous avez bu un ~p~mojito~s~',
	['used_icetea'] = 'Vous avez bu un ~p~icetea~s~',
	['used_wiskycoca'] = 'Vous avez bu un ~p~wisky coca~s~',
	['used_coca'] = 'Vous avez bu un ~p~coca~s~',
	['used_limonade'] = 'Vous avez bu une ~p~limonade~s~',
	['used_fanta'] = 'Vous avez bu un ~p~fanta~s~',
	['used_chips'] = 'Vous avez mangé des ~p~chips~s~',
	['used_cacahuete'] = 'Vous avez mangé des ~p~cacahuètes~s~',
	['used_olive'] = 'Vous avez mangé des ~p~olives~s~',
	['used_burgerclassique'] = 'Vous avez mangé un ~p~Burger~s~',
	['used_chaklik'] = 'Vous avez mangé un ~p~Chaklik~s~',
	['used_bœuf_stroganov'] = 'Vous avez mangé un ~p~Bœuf Stroganov~s~',
	['used_pate_au_truffe'] = 'Vous avez mangé des ~p~Pates Au Truffe~s~',
	['used_riz'] = 'Vous avez mangé du ~p~Riz~s~',
	['used_entrecôte'] = 'Vous avez mangé une ~p~Entrecôte~s~',
	['used_homard_grillé'] = 'Vous avez mangé un ~p~Homard Grillé~s~',
	['used_carpaccio_de_flétan'] = 'Vous avez mangé un ~p~Carpaccio De Flétan~s~',
	['used_salade_césar'] = 'Vous avez mangé une ~p~Salade César~s~',
	['used_crêpes'] = 'Vous avez mangé une ~p~crêpe~s~',
	['used_medovik'] = 'Vous avez mangé un ~p~Medovik~s~',
	['used_frites'] = 'Vous avez mangé des ~p~frites~s~',
	['used_coca'] = 'Vous avez bu un ~p~orangina~s~',
	--Instance
	['left_instance'] = 'vous avez quitté l\'instance',
	['invite_expired'] = 'invitation expirée',
	['press_to_enter'] = 'appuyez sur ~INPUT_CONTEXT~ pour entrer dans l\'instance',
	...
	-- Death
	['please_wait'] = 'réapparition dans ~p~%s minutes %s secondes~s~',
	['press_respawn'] = 'appuyez sur [~p~E] pour réapparaître.',
	['respawn_now_fine'] = 'réapparaître maintenant pour ~g~$%s [Appuyez ~p~E]',
	...
	['not_enough_medikit'] = 'vous n\'avez pas de ~p~kit de soin.',
	['not_enough_bandage'] = 'vous n\'avez pas de ~p~bandage.',
  ...
  -- Cosmetics
	...
	['cartEmptyTxt'] = 'Il n\'y a pas d\'articles dans le panier!',
		...
		['auto_fine_notif'] = 'Excès de vitesse: ~p~%sKm/h ~r~au lieu de ~p~%sKm/h.',
		...
		['no_dmv'] = 'Vous roulez ~y~sans permis ~r~la police est notifié !',
