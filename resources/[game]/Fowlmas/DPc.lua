...
DPc = {
    ...
    MenuImage = "https://i.imgur.com/UDwkpvJ.png", ----[Custom banner IMGUR or GIPHY URLs go here ]---
...
DPc.Languages = {
    ['pt'] = { -- Brazilian Portuguese 🇧🇷
        ...
        ['fr'] = { -- French 🇫🇷
            ...
            ['suggestions'] = "Suggestions?",
            ['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ sur les forums FiveM pour toutes les suggestions!",
