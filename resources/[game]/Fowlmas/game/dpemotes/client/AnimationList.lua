...
RP.Shared = {
	...
	["carrymecute"] = {
        ...
        "Porter quelqu'un de façon romantique",
        "carrymecute2",
        AnimationOptions = {
            EmoteMoving = true,
            EmoteLoop = true
    ...
    ["carrymecute2"] = {
        ...
        "Se faire porter de façon romantique",
        "carrymecute",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
	...
	["carrycmg"] = {
        ...
        "couplepose1cmg_clip",
        "Porter quelqu'un de façon romantique 2",
        "carrycmg2",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true
    ...
    ["carrycmg2"] = {
        ...
        "couplepose2cmg_clip",
        "Se faire porter de façon romantique 2",
        "carrycmg",
        AnimationOptions = {
            EmoteLoop = true,
            Attachto = true,
    ...
    ["sitwithmepose2"] = {
        ...
        "Porter quelqu'un de façon romantique 3",
        "carrymecute",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["couplewed2a"] = { -- Male Custom emote by EnchantedBrownie
        ...
        "wedding2b",
        "Couple pose de mariage (homme) 2",
        "couplewed2b",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true
    ...
    ["couplewed2b"] = { -- Female Custom emote by EnchantedBrownie
        ...
        "wedding2a",
        "Couple pose de mariage (femme) 2",
        "couplewed2a",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["holdmed"] = { -- Custom Animation By SapphireMods
        "mx_couple5_2_b",
        "mx_couple5_2_b_clip",
        "Se faire tenir par quelqu'un 2",
        "holdmec",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["holdmef"] = { -- Custom Animation By SapphireMods
        "mx_couple5_3_b",
        "mx_couple5_3_b_clip",
        "Se faire tenir par quelqu'un 3",
        "holdmee",
        AnimationOptions = {
            EmoteMoving = false,
            EmoteLoop = true,
...
RP.AnimalEmotes = {
    ...
    ["bdogshit"] = {
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['poop'],
            PtfxWait = 200,
            PtfxCanHold = true
        }
    },
    ...
    ["bdogpee"] = {
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['pee'],
            PtfxWait = 3000,
            PtfxCanHold = true
        }
    },
    ...
    ["bdogfw"] = {
       "creatures@rottweiler@amb@world_dog_sitting@base",
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['firework'],
            PtfxWait = 200
        }
    },
    ...
    ["sdogstun"] = {
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['stun'],
            PtfxWait = 200
        }
    },
    ["sdoggl1"] = {
...
RP.Emotes = {
    ...
    ["blowkiss"] = {
        ...
        "blow_kiss",
        "Bisous dans les airs"
    },
    ["blowkiss2"] = {
        "anim@mp_player_intselfieblow_kiss",
        "exit",
        "Bisous dans les airs 2",
        AnimationOptions = {
            EmoteMoving = true,
            EmoteDuration = 2000
        }
    ...
    ["smokeweed"] = {
        ...
        "Fumer de la Weed (Homme)"
    },
    -- Male
    ["smokepot"] = {
        "Scenario",
        "WORLD_HUMAN_SMOKING_POT",
        "Fumer de la Weed (Femme)"
    },
    -- Female
    ["statue"] = {
        "Scenario",
...
RP.PropEmotes = {
   ...
   ["cake4"] = { --- Custom Prop & Emote By BzZzi
    ...
    ["cakew"] = {
        ...
        "idle",
        "Serveur de gâteau d'anniversaire",
        AnimationOptions = {
            Prop = "bzzz_prop_cake_birthday_001",
            PropBone = 28422,
            PropPlacement = {
	...
	["vape"] = {
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['vape'],
            PtfxWait = 0,
            PtfxCanHold = true
        }
    },
    ...
    ["pizzaslice"] = { --- Custom Prop by knjgh
        "mp_player_inteat@burger",
        "mp_player_int_eat_burger",
        "Tranche de pizza jalapeño et peperoni",
        AnimationOptions = {
    ...
    ["pizzas2"] = { --- Custom Prop by knjgh
        "mp_player_inteat@burger",
        "mp_player_int_eat_burger",
        "Tranche de pizza tomate et pesto",
        AnimationOptions = {
    ...
    ["pizzas5"] = { --- Custom Prop by knjgh
        "mp_player_inteat@burger",
        "mp_player_int_eat_burger",
        "Tranche de pizza double peperoni",
        AnimationOptions = {
    ...
    ["guitarcarry4"] = {
        "move_weapon@jerrycan@generic",
        "idle",
        "Tenir une guitare électrique 2",
        AnimationOptions = {
    ...
    ["guitarcarry5"] = {
        "move_weapon@jerrycan@generic",
        "idle",
        "Tenir une guitare électrique 3",
        AnimationOptions = {
            Prop = "prop_el_guitar_03",
            PropBone = 28422,
            PropPlacement = {
    ...
    ["guitarcarry6"] = {
        "move_weapon@jerrycan@generic",
        "idle",
        "Tenir une guitare électrique 4",
        AnimationOptions = {
    ...
    ["guitarcarry7"] = {
        "move_weapon@jerrycan@generic",
        "idle",
        "Tenir une guitare électrique 5",
        AnimationOptions = {
    ...
    ["makeitrain"] = {
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['makeitrain'],
            PtfxWait = 500,
            PtfxCanHold = true
        }
    },
    ["camera"] = {
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['camera'],
            PtfxWait = 200
        }
    },
    ["camera2"] = {
    ...
    ["champagnespray"] = {
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['spraychamp'],
            PtfxWait = 500,
            PtfxCanHold = true
        }
    },
	...
	["weights6"] = { -- Custom Female Emote By Frabi
        "frabi@femalepose@solo@firstsport",
        "fem_pose_sport_002",
        "Soulever des poids pose 2 (femme)",
        AnimationOptions = {
		Prop = 'v_res_tre_weight',
            PropBone = 28422, -- Right Wrist
            PropPlacement = {
	...
	["weights7"] = { -- Custom Female Emote By Frabi
        "frabi@femalepose@solo@firstsport",
        "fem_pose_sport_003",
        "Soulever des poids pose 3 (femme)",
        AnimationOptions = {
    ...
    ["ssign2"] = {
        "rcmnigel1d",
        "base_club_shoulder",
        "Voler un panneau de signalisation",
        AnimationOptions = {
    ...
    ["ssign9"] = {
        "rcmnigel1d",
        "base_club_shoulder",
        "Voler un panneau d'arrêt en neige",
        AnimationOptions = {
    ...
    ["leafblower"] = {
        ...
        AnimationOptions = {
            ...
            PtfxInfo = DPc.Languages[DPc.MenuLanguage]['useleafblower'],
            PtfxWait = 2000,
            PtfxCanHold = true
        }
    },
    ...
    AnimationOptions = {
        ...
        PtfxInfo = DPc.Languages[DPc.MenuLanguage]['puke'],
        PtfxWait = 200,
        PtfxCanHold = true
    },
},
    ["selfiesit"] = { -- Emote by WhiskerValeMod. Need to DPcure camera flash and texture variants
    ...
    ["patrolcarl"] = {
        ...
        "idle_d",
        "Lampe torche dans la voiture 2",
        AnimationOptions = {
            Prop = 'prop_cs_police_torch_02',
            PropBone = 28422,
            PropPlacement = {
    ...
    ["patrolcarr"] = {
        ...
        "idle_a",
        "Lampe torche dans la voiture 3",
        AnimationOptions = {
            Prop = 'prop_cs_police_torch_02',
            PropBone = 28422,
            PropPlacement = {
