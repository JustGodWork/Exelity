if DPc.SqlKeybinding then
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            if not IsPedSittingInAnyVehicle(PlayerPedId()) then
                for k, v in pairs(DPc.KeybindKeys) do
    ...
    AddEventHandler("rp:ClientKeybindGetOne", function(key, e)
        SimpleNotify(DPc.Languages[lang]['bound'] ..
            "~y~" .. e .. "~w~ " .. DPc.Languages[lang]['to'] .. " ~g~" .. firstToUpper(key) .. "~w~")
    ...
    function EmoteBindsStart()
        EmoteChatMessage(DPc.Languages[lang]['currentlyboundemotes'] .. "\n"
    ...
    function EmoteBindStart(source, args, raw)
        if #args > 0 then
            ...
            if (DPc.KeybindKeys[key]) ~= nil then
                ...
                then
                    ...
                    EmoteChatMessage("'" .. emote .. "' " .. DPc.Languages[lang]['notvalidemote'] .. "")
                end
            else
                EmoteChatMessage("'" .. key .. "' " .. DPc.Languages[lang]['notvalidkey'])
            end
        else
            print("invalid")
        end
