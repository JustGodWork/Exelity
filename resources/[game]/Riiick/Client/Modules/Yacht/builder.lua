...
main:isVisible(function(items)
    if id == nil then 
        ...
        items:Button("ID du joueur", "ID select : ~p~"..keyID, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if tel == nil then 
        ...
        items:Button("Coord TP entrée yacht", "Coord select : ~p~"..tel, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if tel2 == nil then 
        ...
        items:Button("Coord TP sortie yacht", "Coord select : ~p~"..tel2, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if tel3 == nil then 
        items:Button("Coord TP entrée capitaine", nil, {LeftBadge = RageUI.BadgeStyle.Star}, true,{
            onSelected = function()
                tel3 = GetEntityCoords(PlayerPedId())
            end
        });
    else
        items:Button("Coord TP entrée capitaine", "Coord select : ~p~"..tel3, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if tel4 == nil then 
        items:Button("Coord TP sortie capitaine", nil, {LeftBadge = RageUI.BadgeStyle.Star}, true,{
            onSelected = function()
                tel4 = GetEntityCoords(PlayerPedId())
            end
        });
    else
        items:Button("Coord TP sortie capitain", "Coord select : ~p~"..tel4, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if posg == nil then 
        ...
        items:Button("Coord garage bateau", "Coord select : ~p~"..posg, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if (veh1 == nil) or (veh2_yacht == nil) then 
        ...
        items:Button("Choix des véhicules", "Véhicules choisis : ~p~"..veh1..", "..veh2_yacht, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if possv == nil then 
        ...
        items:Button("Coord sortie de bateau", "Coord select : ~p~"..possv, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if posv == nil then 
        ...
        items:Button("Coord Coffre / Vestiaire", "Coord select : ~p~"..posv, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if posdj == nil then 
        ...
        items:Button("Coord DJ", "Coord select : ~p~"..posdj, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if posdec == nil then 
        ...
        items:Button("Coord Lit (disconect)", "Coord select : ~p~"..posdec, {LeftBadge = RageUI.BadgeStyle.Star}, false,{});
    end;
    if id ~= nil and posg ~= nil and veh1 ~= nil and veh2_yacht ~= nil and possv ~= nil and posv ~= nil and posdj ~= nil and posdec ~= nil then 
        items:Button("Valider", nil, {LeftBadge = RageUI.BadgeStyle.Star, Color = {BackgroundColor = {56, 171, 114, 100}}}, true,{
            onSelected = function()
                TriggerServerEvent("Riiick:addYacht", id, posg, veh1, veh2_yacht, possv, posv, posdj, posdec, tel, tel2, tel3, tel4)
                main:toggle();
            end
        });
    else
