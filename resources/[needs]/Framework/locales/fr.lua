Locales['fr'] = {
	...
	['gave_item'] = 'vous avez donné ~p~%sx~s~ ~r~%s~s~ à ~p~%s~s~',
	['received_item'] = 'vous avez reçu ~p~%sx~s~ ~r~%s~s~ par ~p~%s~s~',
	['gave_weapon'] = 'vous avez donné ~p~1x~s~ ~r~%s~s~ à ~p~%s~s~',
	['gave_weapon_ammo'] = 'vous avez donné ~p~%sx~s~ balles pour ~p~%s~s~ à ~p~%s~s~',
	['gave_weapon_withammo'] = 'vous avez donné ~p~1x~s~ ~r~%s~s~ avec ~p~%sx~s~ balles à ~p~%s~s~',
	['gave_weapon_hasalready'] = '~p~%s~s~ a déjà ~p~%s~s~',
	['gave_weapon_noweapon'] = '~p~%s~s~ n\'a pas cette arme',
	['received_weapon'] = 'vous recevez ~p~1x~s~ ~p~%s~s~ de ~p~%s~s~',
	['received_weapon_ammo'] = 'vous avez reçu ~p~%sx~s~ balles pour votre ~p~%s~s~ de ~p~%s~s~',
	['received_weapon_withammo'] = 'vous avez reçu ~p~1x~s~ ~p~%s~s~ avec ~p~%sx~s~ balles de ~p~%s~s~',
	['received_weapon_hasalready'] = '~p~%s~s~ a tenté de vous donner ~p~%s~s~, mais vous en aviez déjà un exemplaire',
	['received_weapon_noweapon'] = '~p~%s~s~ tente de vous donner des munitions pour ~p~%s~s~, mais vous n\'en avez pas',
	['gave_money'] = 'vous avez donné ~g~$%s~s~ à ~p~%s~s~',
	['received_money'] = 'vous avez reçu ~g~$%s~s~ par ~p~%s~s~',
	['gave_account_money'] = 'vous avez donné ~g~$%s~s~ (%s) à ~p~%s~s~',
	['received_account_money'] = 'vous avez reçu ~g~$%s~s~ (%s) par ~p~%s~s~',
	['amount_invalid'] = 'montant invalide',
	['players_nearby'] = 'aucun joueur à proximité',
	['ex_inv_lim'] = 'action impossible, depassement de la limite d\'inventaire pour ~p~%s~s~',
	['imp_invalid_quantity'] = 'action impossible, ~r~quantité invalide',
	['imp_invalid_amount'] = 'action impossible, ~r~montant invalide',
	['threw_standard'] = 'vous avez jeté ~p~%sx~s~ ~p~%s~s~',
	['threw_money'] = 'vous avez jeté ~g~$%s~s~ ~p~cash~s~',
	['threw_account'] = 'vous avez jeté ~g~$%s~s~ ~p~%s~s~',
	['threw_weapon'] = 'vous avez jeté ~p~1x~s~ ~p~%s~s~',
	['threw_weapon_ammo'] = 'vous avez jeté ~p~1x~s~ ~p~%s~s~ avec ~p~%sx~s~ balles',
	['threw_weapon_already'] = 'you already carry the same weapon',
	['threw_cannot_pickup'] = 'vous ne pouvez ramasser ceci, inventaire plein !',
	['threw_pickup_prompt'] = 'appuyer sur ~p~E~s~ pour ramasser',
	...
	['money_set'] = 'quelqu\'un de ~p~haut placé~s~ vous a attribué ~g~$%s~s~ (%s) !',
