...
function ESX.ShowNotification(msg, flash, saveToBrief, hudColorIndex, title, subject, icon)
    if title == nil then title = "Exelity" end
    if subject == nil then subject = "Notification" end
    if icon == nil then icon = "message" end

    exports.eNotif:Send(msg, nil, nil, true, nil, title, subject, icon);
end 
...
function ESX.ShowAdvancedNotification(title, subject, msg, banner, timeout, icon)
    ...
    exports.eNotif:SendAdvanced(msg, subject, title, banner, nil, nil, true, nil, icon)
end
...
function ESX.OpenSocietyMenu(societyName)
	exports["JustGod"]:OpenSocietyMenu(societyName);
end

---@param societyName string
function ESX.OpenSocietyChest(societyName)
	exports["JustGod"]:OpenSocietyChest(societyName);
end

---@param societyName string
---@param plate string
function ESX.ParkSocietyVehicle(societyName, plate)
	exports["JustGod"]:ParkSocietyVehicle(societyName, plate);
end

---@param societyName string
---@param coords vector3
function ESX.OpenSocietyGarage(societyName, coords)
	exports["JustGod"]:OpenSocietyGarage(societyName, coords);
end